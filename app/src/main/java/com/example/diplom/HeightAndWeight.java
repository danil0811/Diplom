...
public class HeightAndWeight extends AppCompatActivity {
        ...
        db.collection("users")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        // Сохранение ИМТ и переход к следующей активности
    ...
    private void calculateAndSaveBMI(String weight, String height) {
        double weightValue = Double.parseDouble(weight);
        double heightValue = Double.parseDouble(height) / 100; // Конвертировать в метры
        ...
        // Переход к активности ViborTrenirovki
