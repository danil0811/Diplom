...
public class PushupWithEmphasis extends AppCompatActivity {

    private static final String TAG = "PushupWithEmphasis";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pushup_with_emphasis);

        tvReps = findViewById(R.id.Reps);
        ivQuestion = findViewById(R.id.question);
        btnFinish = findViewById(R.id.FinishFithExercise);
    ...
    private void showBottomSheetDialog() {
        ...
        Exercise exercise = new Exercise("Отжимание с упором впереди", "Исходное положение - обычное положение для отжиманий, но с руками на стуле или скамье (любой упор перед собой)", "", "2 подхода по 8 повторений",10);

        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(PushupWithEmphasis.this);
        ...
        buttonWatchVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (videoUrl != null && !videoUrl.isEmpty()) {
                    ...
                    Toast.makeText(PushupWithEmphasis.this, "Видео недоступно", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void startRestActivity() {
        Intent intent = new Intent(PushupWithEmphasis.this, RestActivity.class);
